    ...
    <div class="col-span-12 space-y-3 md:col-span-9">
        ...
        <div
            ...
            <div
                ...
                <span class="relative text-white h-100">{{ __('Online Vrienden') }}</span>
            </div>
            ...
            <div class="relative flex flex-1 items-center justify-center gap-2 pl-2 h-100 sm:justify-start">
                @foreach ($onlineFriends as $friend)
                    <div data-popover-target="friend-{{ $friend->username }}"
                         style="image-rendering: pixelated; background-image: url({{ setting('avatar_imager') }}{{ $friend->look }}&direction=2&head_direction=3&gesture=sml&action=wav&headonly=1&size=5)"
                    ...
                    <div data-popover id="friend-{{ $friend->username }}" role="tooltip"
                        ...
                        <div class="overflow-y-auto px-3 py-2" style="max-height: 200px">
                            ...
                            <b
                                class="mr-1 font-bold">{{ __('Online Sinds') }}
    ...
    @push('javascript')
        <script>
            ...
            function copyCode() {
                ...
                Toast.fire({
                    icon: "success",
                    title: '{{ __('Je verwijzingscode is naar je clipbord gekopieerd!') }}'
                });
            }
        </script>
    @endpush
